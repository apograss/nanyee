...
import { Image as ImageIcon, CheckCircle2, ArrowRight, KeyRound, MapPin, Send } from "lucide-react";
    ...
    <div className="max-w-4xl mx-auto flex flex-col gap-5" data-component="QunPage" data-od-id="qun">
      ...
      <Card>
        ...
        <CardContent className="flex flex-col gap-3">
          ...
          <div id="qun-cookie-tutorial" data-tutorial-slot="qun-cookie" className="rounded-[var(--radius)] border border-dashed border-border p-4 text-[13px] text-[var(--muted)]">
            群报数 Cookie / Token 获取教程（待补充）
          </div>
