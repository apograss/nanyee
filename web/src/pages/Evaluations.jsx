...
export default function Evaluations() {
  ...
  return (
    <div className="max-w-4xl mx-auto flex flex-col gap-5" data-component="EvaluationsPage" data-od-id="evaluations">
      <div className="flex flex-col gap-1">
        <div className="text-[11px] tracking-[0.1em] uppercase text-[var(--muted)]">托管自动评课</div>
        <h1>自动评课</h1>
        <p className="text-[var(--muted)] text-sm">提交后会在后台自动完成全部课程的评教，遇到验证码自动重试，关闭浏览器也不影响执行。</p>
      </div>
      ...
      <div className="text-[12px] text-[var(--muted)] text-center">
